...
{
    [DbContext(typeof(BankDbContext2))]
    [Migration("20220326055947_AddressIsNowNullableInDatabase")]
    partial class AddressIsNowNullableInDatabase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataBaseTest.Models.CustomerModel", b =>
                {
                    b.Property<int?>("CustomerModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("LoginCredentialModelId")
                        .IsUnique()
                        .HasFilter("[LoginCredentialModelId] IS NOT NULL");
            ...
            modelBuilder.Entity("DataBaseTest.Models.AccountModel", b =>
                {
                    b.HasOne("DataBaseTest.Models.CustomerModel", null)
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("DataBaseTest.Models.CustomerModel", b =>
                {
                    b.HasOne("DataBaseTest.Models.LoginCredentialModel", "LoginCredential")
                        .WithOne()
                        .HasForeignKey("DataBaseTest.Models.CustomerModel", "LoginCredentialModelId");

                    b.HasOne("DataBaseTest.Models.PersonModel", "Person")
                        .WithOne()
                        .HasForeignKey("DataBaseTest.Models.CustomerModel", "PersonModelId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
